		...
		<Box flexDirection="column" marginTop={1}>
			...
			{teamStandings && (
				<>
					<StatRow
						label="Record"
						awayValue={getRecord(teamStandings.away)}
						homeValue={getRecord(teamStandings.home)}
					/>
					<StatRow
						label="Points"
						awayValue={getPoints(teamStandings.away)}
						homeValue={getPoints(teamStandings.home)}
					/>
					<Box marginBottom={1} />
				</>
			)}
